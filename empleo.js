const formulario = document.getElementById('formulario__1');
const inputs = document.querySelectorAll('#formulario__1 input');
...
formulario.addEventListener('submit', (e) => {
	...
	if(campos.nombre && campos.apellido && campos.direccion && campos.cp && campos.localidad && campos.provincia && campos.correo && campos.telefono && terminos.checked ){
		formulario.reset();
